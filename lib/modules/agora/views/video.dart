          ...
          children: [
            AgoraVideoView(
              controller: VideoViewController(
                ...
                useAndroidSurfaceView: controller.isUseAndroidSurfaceView.value,
              ),
          ...
          children: [
              ...
              children: [
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('${controller.isJoined.value ? 'Leave' : 'Join'} channel'),
                  ),
                )
              ],
            ),
            if (defaultTargetPlatform == TargetPlatform.android ||
              ...
              ElevatedButton(
                ...
                child: Text('Camera ${controller.switchCamera.value ? 'front' : 'rear'}'),
              ),
            ],
          ],
        );
